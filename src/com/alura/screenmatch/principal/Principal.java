...
public class Principal {
    public static void main(String[] args) {
        ...
        var peliculaDeBruno = new Pelicula("El señor de los anillos", 2001);  //equivale a:  Pelicula peliculaDeBruno = new Pelicula();  var hace la inferencia del tipo de datos que sera la variable pelculaDeBruno, en este caso Pelicula
        ...
        System.out.println(listaDePeliculas.toString());   //antes:   System.out.println(listaDePeliculas);
        System.out.println(listaDePeliculas.get(0).toString());  //antes:  System.out.println(listaDePeliculas.get(0));
    }
}